      ...
      res.on('end', function() {
         ...
         for ( var i = 0; i < originalIndex.apis.length; i++ ){
            ...
            for ( var j = 0; j < index.apis[i].operations.length; j++){
               ...
               var nick  = index.apis[i].operations[j].nickname
               var camel = 'get' + nick.charAt(0).toUpperCase() + camelCase(nick.slice(1))

               index.apis[i].operations[j].nickname = camel
